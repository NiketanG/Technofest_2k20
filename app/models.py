...
class registrations(db.Model):
    ...
    def __repr__(self):
        return f"Registration('{self.name}', '{self.email}' , '{self.clgname}', '{self.phno}', '{self.grpname}', '{self.event_id}', '{self.team}', '{self.user}', '{self.date_registered}', '{self.paid}', '{self.order_id}', '{self.cust_id}', '{self.amt}',)"
