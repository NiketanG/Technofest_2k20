...
class RegistrationForm(FlaskForm):
    name = StringField('Name : ', [DataRequired("Name cannot be left blank")], render_kw={
                       "placeholder": "Severus Snape", "id": "name", "maxlength": "25"})
    ...
    clgname = StringField('Institute Name : ', [DataRequired("College Name cannot be left blank")], render_kw={
                          "placeholder": "Hogwarts School of Witchcraft and Wizardry", "id": "ClgName", "maxlength": "25"})
